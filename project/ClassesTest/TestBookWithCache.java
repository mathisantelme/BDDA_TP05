...
public class TestBookWithCache {
    ...
    public void testInsertNewBook() throws BookException {
        // clean db
        bm.deleteAll();
    ...
    public void testFindExistingBook() throws BookException {
        // clean db
        bm.deleteAll();
        // save a new book in db
        bm.insert(JPAbook);
    ...
    public void testFindManyExistingBook() throws BookException {
        // clean db
        bm.deleteAll();
        // save a new book in db
        bm.insert(JPAbook);
    ...
    public void testFindNotExistingBook() throws BookException {
    ...
    public void testFindCacheManagement() throws BookException {
        // clean db
        bm.deleteAll();
        // save a new book in db
        bm.insert(JPAbook);
    ...
    public void testUpdateExistingBook() throws BookException {
        // clean db
        bm.deleteAll();
        // save a new book in db
        bm.insert(JPAbook);
    ...
    public void testUpdateNotExistingBook() throws BookException {
        // clean db
        bm.deleteAll();
    ...
    public void testUpdateCacheManagement() throws BookException {
        // clean db
        bm.deleteAll();
        // save a new book in db
        bm.insert(JPAbook);
    ...
    public void testDeleteExistingBook() throws BookException {
        // clean db
        bm.deleteAll();
        // save a new book in db
        bm.insert(JPAbook);
    ...
    public void testDeleteNotExistingBook() throws BookException {
        // clean db
        bm.deleteAll();
    ...
    public void testDeleteAll() throws BookException {
        // clean db
        bm.deleteAll();
    ...
    public void testDeleteCacheManagement() throws BookException {
        // clean db
        bm.deleteAll();
        // save a new book in db
        bm.insert(JPAbook);
